...
Product::Product(const char* name, struct tm expiredate, struct tm importdate, const char* developer, const int quantity, const int place, const char* comment) 
{
...
Product::Product() :Product("Unknown", {0}, {0}, "Unknown", 0, 0, "Unknown") {};
